/****************************************************************************
** Meta object code from reading C++ file 'PreviewPanel.h'
**
...
#error "The header file 'PreviewPanel.h' doesn't include <QObject>."
...
void PreviewPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PreviewPanel::*)()>(_a, &PreviewPanel::gameEnded, 0))
            return;
    }
}
